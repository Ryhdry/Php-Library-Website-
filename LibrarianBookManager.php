...
<div class="navbar">
    ...
    <div class="heading">
        ...
        <form>
        <button type="submit" formaction="Librarian.php">Log Out</button>
        </form>
</div>
    <div class="heading">
        <div class ="card" onclick="location.href='LibrarianView.php';" >
            <h5>View Books</h5>
        </div>
        <div class ="card" onclick="location.href='LibrarianSearch.php';">
            <h5>Search Books</h5>
        </div>
        <div class ="card" onclick="location.href='GuestSearch.php';">
            <h5>Edit Account</h5>
        </div>
        <div class ="card" onclick="location.href='GuestSearch.php';">
            <h5>Manage Books</h5>
